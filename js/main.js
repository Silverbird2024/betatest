...
$App.mbe01 = $scope.Calculate($App.M001+"/"+$App.mpw01,4);
$App.tmcv001 = $scope.Calculate($App.mpq01+"*6",4);};
$App.NAB.Headline122_hidden=true;
...
$scope.PushButton14_click = function() {$scope.GotoPage( "ExampleONE2series" );};
$scope.Pager2_prevclick = function() {$scope.GotoPrevPage();};
$scope.Pager2_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("FirstPage_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 2;
$App.NAB.PageID = "FirstPage";
$scope.PushButton11_click = function() {$App.once = "once";
localStorage.setItem("once",$App.once);
if ($App.once == "once") {
$scope.GotoPage( "ExampleONE2series" );
} else {
};
if($App.NAB["Machinestansus001"]){$App.NAB["Machinestansus001"].click();}else{$("#"+"Machinestansus001").click();}
...
localStorage.setItem("L02com5k",$App.L02com5k);
localStorage.setItem("L02com10k",$App.L02com10k);};
$scope.PushButton12_click = function() {$scope.GotoPage( "Edit01" );
$scope.GotoPage( "FirstPage" );
$scope.ShowObject("Headline122","fadeIn",44);};
$scope.PushButton13_click = function() {$scope.GotoPage( "ExampleONE2series" );};
...
$scope.PushButton1_click = function() {$App.pass = 708;
if ($App.pass == "708") {
...
$scope.Dropdown2_change = function(value) {$App.size01 = value;
if ($App.size01 == "40 x 20 vellum 1000 labels pw") {
$App.PL001 = $App.L01com1k;
$App.LPW = 1000;
$App.lpq = $scope.Calculate($App.LPW+"*13",-1);
$App.cpq = $scope.Calculate($App.lpq+"*"+$App.PL001,-1);
$App.pq = "13OOO";
...
if($App.NAB["PushButton15"]){$App.NAB["PushButton15"].click();}else{$("#"+"PushButton15").click();}};
...
localStorage.setItem("L02com5k",$App.L02com5k);
localStorage.setItem("L02com10k",$App.L02com10k);};
$scope.PushButton3_click = function() {$App.L01comk = $scope.Calculate($App.q40x20vel01+"+"+$App.q40x20f01,4);
$App.L01com = $scope.Calculate($App.L01comk+"/1000",4);
$App.L01c0mpc = $scope.Calculate($App.L01com+"/100",-1);
$App.L01comr = $scope.Calculate($App.L01c0mpc+"*"+$App.L1000,-1);
$App.L01com1k = $scope.Calculate($App.L01comr+"+"+$App.L01com,-1);
...
localStorage.setItem("L03com5k",$App.L03com5k);
localStorage.setItem("L03com10k",$App.L03com10k);};
$scope.TextInput20_change = function() {localStorage.setItem("q50x25vel01",$App.q50x25vel01);};
$scope.TextInput21_change = function() {localStorage.setItem("q50x25f01",$App.q50x25f01);};
$scope.TextInput22_change = function() {localStorage.setItem("L1000",$App.L1000);};
$scope.TextInput23_change = function() {localStorage.setItem("L2000",$App.L2000);};
$scope.TextInput24_change = function() {localStorage.setItem("L5000",$App.L5000);};
$scope.TextInput25_change = function() {localStorage.setItem("L10000",$App.L10000);};
$scope.TextInput26_change = function() {localStorage.setItem("mpw01",$App.mpw01);};
$scope.PushButton2_click = function() {$App.L01comk = $scope.Calculate($App.q40x20vel01+"+"+$App.q40x20f01,4);
$App.L01com = $scope.Calculate($App.L01comk+"/1000",4);
$App.L01c0mpc = $scope.Calculate($App.L01com+"/100",-1);
$App.L01comr = $scope.Calculate($App.L01c0mpc+"*"+$App.L1000,-1);
$App.L01com1k = $scope.Calculate($App.L01comr+"+"+$App.L01com,-1);
...
localStorage.setItem("L03com5k",$App.L03com5k);
localStorage.setItem("L03com10k",$App.L03com10k);};
$scope.TextInput1_change = function() {localStorage.setItem("q75x50vel01",$App.q75x50vel01);};
$scope.TextInput2_change = function() {localStorage.setItem("q75x50f01",$App.q75x50f01);};
...
$scope.TextInput27_change = function() {localStorage.setItem("mpw01",$App.mpw01);};
$scope.PushButton5_click = function() {$App.L01comk = $scope.Calculate($App.q40x20vel01+"+"+$App.q40x20f01,4);
$App.L01com = $scope.Calculate($App.L01comk+"/1000",4);
$App.L01c0mpc = $scope.Calculate($App.L01com+"/100",-1);
$App.L01comr = $scope.Calculate($App.L01c0mpc+"*"+$App.L1000,-1);
$App.L01com1k = $scope.Calculate($App.L01comr+"+"+$App.L01com,-1);
...
$scope.TextInput28_change = function() {localStorage.setItem("mpw01",$App.mpw01);};
$scope.PushButton7_click = function() {$App.L01comk = $scope.Calculate($App.q40x20vel01+"+"+$App.q40x20f01,4);
$App.L01com = $scope.Calculate($App.L01comk+"/1000",4);
$App.L01c0mpc = $scope.Calculate($App.L01com+"/100",-1);
$App.L01comr = $scope.Calculate($App.L01c0mpc+"*"+$App.L1000,-1);
$App.L01com1k = $scope.Calculate($App.L01comr+"+"+$App.L01com,-1);
...
localStorage.setItem("L03com5k",$App.L03com5k);
localStorage.setItem("L03com10k",$App.L03com10k);};
$scope.TextInput29_change = function() {localStorage.setItem("q75x50vel01",$App.q75x50vel01);};
$scope.TextInput30_change = function() {localStorage.setItem("q75x50f01",$App.q75x50f01);};
$scope.TextInput31_change = function() {localStorage.setItem("L1000",$App.L1000);};
$scope.TextInput32_change = function() {localStorage.setItem("L2000",$App.L2000);};
$scope.TextInput33_change = function() {localStorage.setItem("L5000",$App.L5000);};
$scope.TextInput34_change = function() {localStorage.setItem("L10000",$App.L10000);};
$scope.TextInput35_change = function() {localStorage.setItem("mpw01",$App.mpw01);};
$scope.PushButton9_click = function() {$App.L01comk = $scope.Calculate($App.q40x20vel01+"+"+$App.q40x20f01,4);
$App.L01com = $scope.Calculate($App.L01comk+"/1000",4);
$App.L01c0mpc = $scope.Calculate($App.L01com+"/100",-1);
$App.L01comr = $scope.Calculate($App.L01c0mpc+"*"+$App.L1000,-1);
$App.L01com1k = $scope.Calculate($App.L01comr+"+"+$App.L01com,-1);
...
localStorage.setItem("L03com5k",$App.L03com5k);
localStorage.setItem("L03com10k",$App.L03com10k);};
$scope.TextInput36_change = function() {localStorage.setItem("q75x50vel01",$App.q75x50vel01);};
$scope.TextInput37_change = function() {localStorage.setItem("q75x50f01",$App.q75x50f01);};
$scope.TextInput38_change = function() {localStorage.setItem("L1000",$App.L1000);};
$scope.TextInput39_change = function() {localStorage.setItem("L2000",$App.L2000);};
$scope.TextInput40_change = function() {localStorage.setItem("L5000",$App.L5000);};
$scope.TextInput41_change = function() {localStorage.setItem("L10000",$App.L10000);};
$scope.TextInput42_change = function() {localStorage.setItem("mpw01",$App.mpw01);};
$scope.PushButton10_click = function() {$App.L01comk = $scope.Calculate($App.q40x20vel01+"+"+$App.q40x20f01,4);
$App.L01com = $scope.Calculate($App.L01comk+"/1000",4);
$App.L01c0mpc = $scope.Calculate($App.L01com+"/100",-1);
$App.L01comr = $scope.Calculate($App.L01c0mpc+"*"+$App.L1000,-1);
$App.L01com1k = $scope.Calculate($App.L01comr+"+"+$App.L01com,-1);
...
localStorage.setItem("L03com5k",$App.L03com5k);
localStorage.setItem("L03com10k",$App.L03com10k);};
$scope.TextInput43_change = function() {localStorage.setItem("q75x50vel01",$App.q75x50vel01);};
$scope.TextInput44_change = function() {localStorage.setItem("q75x50f01",$App.q75x50f01);};
$scope.TextInput45_change = function() {localStorage.setItem("L1000",$App.L1000);};
$scope.TextInput46_change = function() {localStorage.setItem("L2000",$App.L2000);};
$scope.TextInput47_change = function() {localStorage.setItem("L5000",$App.L5000);};
$scope.TextInput48_change = function() {localStorage.setItem("L10000",$App.L10000);};
$scope.TextInput49_change = function() {localStorage.setItem("mpw01",$App.mpw01);};
});
